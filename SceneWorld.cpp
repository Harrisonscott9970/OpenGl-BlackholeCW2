...
void SceneBasic_Uniform::renderAsteroids(const glm::mat4& view, const glm::mat4& proj, float t)
{
    ...
    // Asteroid material: rough carbonaceous chondrite — no metallic sheen,
    // very high roughness gives broad GGX lobe (rock-like diffuse highlight)
    ...
    for (const auto& asteroid : asteroids)
    {
        ...
        // Dark charcoal asteroids, glow hot orange as they fall into BH
        glm::vec3 baseColor = glm::mix(glm::vec3(0.06f, 0.06f, 0.07f),
            glm::vec3(0.22f, 0.14f, 0.08f), pullT * 0.45f);
        glm::vec3 glowColor = glm::mix(glm::vec3(0.04f, 0.04f, 0.05f),
            glm::vec3(1.80f, 0.55f, 0.08f), pullT * 0.95f);
